...
'Wie ooit seks heeft gehad met iemand buiten deze groep drinkt {0}',
...
'De persoon met langste naam drinkt {0}',
...
export {SoloFactory, DuoFactory, GroupFactory, NhieFactory};
